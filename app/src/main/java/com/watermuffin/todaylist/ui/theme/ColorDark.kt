...
// Темная тема
val primaryColorDark = Color(0xFF2BB2AB)
val primaryTextColorDark = Color(0xFF2BB2AB)
val secondaryColorDark = Color(0xFF676767)
...
val avatarDefaultDark = Color(0xFF2BB2AB)